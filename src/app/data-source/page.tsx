export default function DataSourcePage() {
  return (
    <main className="shell with-tabbar">
      <header className="topbar"><div className="logo"><span className="logo-mark">🧊</span>데이터 출처</div><a className="ghost" href="/">홈</a></header>
      ...
      <nav className="tabbar"><a href="/">홈</a><a href="/saved">저장</a><a className="active" href="/data-source">데이터</a><a href="/settings">설정</a></nav>
    </main>
  );
}
