...
export const LINE_ORDERS: Record<string, { circular?: boolean; stations: string[] }> = {
  ...
  '8호선': {
    circular: false,
    stations: [
      '별내역', '다산역', '동구릉역', '구리역', '장자호수공원역', '암사역사공원역', '암사역', '천호역', '강동구청역',
      '몽촌토성역', '잠실역', '석촌역', '송파역', '가락시장역', '문정역', '장지역', '복정역', '산성역',
      '남한산성입구역', '단대오거리역', '신흥역', '수진역', '모란역',
    ],
  },
  '공항철도': {
    circular: false,
    stations: ['서울역', '공덕역', '홍대입구역', '디지털미디어시티역', '마곡나루역', '김포공항역', '계양역', '검암역', '청라국제도시역', '영종역', '운서역', '공항화물청사역', '인천공항1터미널역', '인천공항2터미널역'],
  },
  '신분당선': {
    circular: false,
    stations: ['신사역', '논현역', '신논현역', '강남역', '양재역', '양재시민의숲역', '청계산입구역', '판교역', '정자역', '미금역', '동천역', '수지구청역', '성복역', '상현역', '광교중앙역', '광교역'],
  },
  '수인분당선': {
    circular: false,
    stations: [
      '청량리역', '왕십리역', '서울숲역', '압구정로데오역', '강남구청역', '선정릉역', '선릉역', '한티역', '도곡역', '구룡역',
      '개포동역', '대모산입구역', '수서역', '복정역', '가천대역', '태평역', '모란역', '야탑역', '이매역', '서현역',
      '수내역', '정자역', '미금역', '오리역', '죽전역', '보정역', '구성역', '신갈역', '기흥역', '상갈역', '청명역',
      '영통역', '망포역', '매탄권선역', '수원시청역', '매교역', '수원역', '고색역', '오목천역', '어천역', '야목역',
      '사리역', '한대앞역', '중앙역', '고잔역', '초지역', '안산역', '신길온천역', '정왕역', '오이도역', '달월역',
      '월곶역', '소래포구역', '인천논현역', '호구포역', '남동인더스파크역', '원인재역', '연수역', '송도역',
      '인하대역', '숭의역', '신포역', '인천역',
    ],
  },
  '3호선': {
